...
|            | Description                                                                                                                                                                                   | Fill in |
| ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| Tech Stack | Python/Flask, PostgreSQL, SQLAlchemy, Render, Jinja, RESTful APIs, JavaScript, HTML, CSS.                                                                                                     |         |
| Type       | This will be a website.                                                                                                                                                                       |         |
| Goal       | Goal is to demostrate my skills using all the technologies learned so far in the course. For the app, the goal is for users to be able to access and track weather data for cities in Ontario |         |
| Users      | Young adults, aged 18-25 interested in travelling and keeping tabs on the weather forecast of these places.                                                                                   |         |
| Data       | Temperature and Forecasts                                                                                                                                                                     |         |
